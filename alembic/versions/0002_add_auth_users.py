...
def upgrade() -> None:
    ...
    op.add_column("crisis_sessions", sa.Column("created_by_id", sa.Integer(), nullable=True))
    op.add_column("crisis_sessions", sa.Column("created_by_username", sa.String(length=128), nullable=False, server_default=""))
    op.add_column("crisis_sessions", sa.Column("created_by_role", sa.String(length=32), nullable=False, server_default=""))
...
def downgrade() -> None:
    ...
    op.drop_column("crisis_sessions", "created_by_role")
    op.drop_column("crisis_sessions", "created_by_username")
    op.drop_column("crisis_sessions", "created_by_id")
