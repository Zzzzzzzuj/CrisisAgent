...
from backend.agents import legal_agent, redteam_agent, sentiment_agent, writer_agent
...
def main() -> None:
    ...
    second_draft = writer_agent.generate_second_draft(
        {
            "event": TEST_EVENT,
