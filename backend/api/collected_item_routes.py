...
def list_collected_items(
    ...
    items = get_collected_item_store().list_items(source_id=source_id, ingestion_run_id=ingestion_run_id, status=status, entity_id=entity_id, provider=provider, limit=limit)
